...
const nav = ['Overview', 'Opportunities', 'Discovery', 'Research', 'Domain Generator', 'Expired Domains', 'Auctions', 'Watchlists', 'Buyer Research', 'Portfolio', 'Renewals', 'Outreach', 'Analytics', 'Reports', 'Notifications', 'Integrations', 'Operations', 'Settings', 'Admin'];
