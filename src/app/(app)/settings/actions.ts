...
export async function updateRuntimeSettings(formData: FormData): Promise<void> {
  ...
  const config = await updateAppConfig({
    ...
    abuseProtection: {
      enabled: formData.get('abuseProtectionEnabled') === 'on',
      loginIpLimit: Number(formData.get('loginIpLimit')),
      loginAccountLimit: Number(formData.get('loginAccountLimit')),
      loginWindowMinutes: Number(formData.get('loginWindowMinutes')),
      registrationIpLimit: Number(formData.get('registrationIpLimit')),
      registrationWindowMinutes: Number(formData.get('registrationWindowMinutes')),
      recoveryIpLimit: Number(formData.get('recoveryIpLimit')),
      recoveryAccountLimit: Number(formData.get('recoveryAccountLimit')),
      recoveryWindowMinutes: Number(formData.get('recoveryWindowMinutes')),
      verificationAccountLimit: Number(formData.get('verificationAccountLimit')),
      verificationWindowMinutes: Number(formData.get('verificationWindowMinutes')),
    },
    schedulerEnabled,
    schedulerPollMs,
    jobSchedules: {
